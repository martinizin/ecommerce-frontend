...
export const routes: Routes = [
    ...
    { path:'productos',component:ClientesComponent,canActivate: [RoleGuard],data: { expectedRole: ['ROLE_ADMIN','ROLE_EMPRENDEDOR','ROL_CLIENT']}},
    { path:'crear-cuenta-bancaria',component:FormularioCuentaBancariaComponent,canActivate: [RoleGuard],data: { expectedRole: ['ROLE_EMPRENDEDOR','ROL_CLIENT']}},
    //{path:'cuenta-bancaria/:idEmprendedor',component:CuentaBancariaComponent},
    { path:'cuenta-bancaria',component:CuentaBancariaComponent,canActivate: [RoleGuard],data: { expectedRole: ['ROLE_EMPRENDEDOR','ROL_CLIENT']}},
    { path:'realizar-compra',component:RealizarCompraComponent, canActivate: [RoleGuard],data: { expectedRole: ['ROLE_EMPRENDEDOR','ROL_CLIENT']}},
    ...
    { path:'todos-productos',component:ListadoProductosComponent,canActivate: [RoleGuard],data: { expectedRole: ['ROLE_ADMIN','ROL_CLIENT']}},
    { path: 'carrito', component: CarritoComprasComponent,canActivate: [RoleGuard],data: { expectedRole: ['ROL_CLIENT','ROLE_ADMIN']} },
    { path:'fin-compra',component:VentanasEmergentesComponent,canActivate: [RoleGuard],data: { expectedRole: ['ROLE_ADMIN','ROL_CLIENT','ROL_EMPRENDEDOR']}},
    { path:'mis-compras',component:MisComprasComponent,canActivate: [RoleGuard],data: { expectedRole: ['ROL_CLIENT','ROL_EMPRENDEDOR']}},
    { path:'mis-ventas',component:MisVentasComponent,canActivate: [RoleGuard],data: { expectedRole: ['ROL_CLIENT','ROL_CLIENT']}},
